...
public class AccountEnableReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (prefsAccountIndex < 0 || prefsAccountIndex >= XecurePreferences.instance().getAccountCount())
			return;
		XecurePreferences.instance().setAccountEnabled(prefsAccountIndex, enable);
	}
}
