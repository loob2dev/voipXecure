...
public class XecureNumberOrAddress implements Serializable, Comparable<XecureNumberOrAddress> {
	...
	public XecureNumberOrAddress(String v, boolean isSIP) {
		value = v;
		isSIPAddress = isSIP;
		oldValueForUpdatePurpose = null;
	}

	public XecureNumberOrAddress(String v, boolean isSip, String old) {
		this(v, isSip);
		oldValueForUpdatePurpose = old;
	}

	@Override
	public int compareTo(XecureNumberOrAddress noa) {
