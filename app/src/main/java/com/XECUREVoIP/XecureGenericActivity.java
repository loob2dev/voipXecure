...
public class XecureGenericActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        if (!XecureService.isReady()) {
            finish();
            startService(getIntent().setClass(this, XecureService.class));
            return;
        }
        if (!XecureManager.isInstanciated()) {
            finish();
            startActivity(getIntent().setClass(this, XecureLauncherActivity.class));
            return;
        }
    }
}
