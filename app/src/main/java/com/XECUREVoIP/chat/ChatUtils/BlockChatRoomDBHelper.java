...
public class BlockChatRoomDBHelper extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "BlockChatRooms.db";
    ...
    public BlockChatRoomDBHelper(@Nullable Context context) {
