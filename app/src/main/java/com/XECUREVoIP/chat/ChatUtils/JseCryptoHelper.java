...
public class JseCryptoHelper extends CryptoHelper {
    ...
    private static Key loadEcPublicKey(byte [] pubKey) throws NoSuchAlgorithmException,
            InvalidKeySpecException {
