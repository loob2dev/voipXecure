package com.XECUREVoIP.purchase;
/*
...
public class InAppPurchaseFragment extends Fragment implements View.OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		defaultUsername = XecurePreferences.instance().getAccountUsername(XecurePreferences.instance().getDefaultAccountIndex());
		...
		if(!getResources().getBoolean(R.bool.hide_username_in_inapp)){
			...
			username.setText(XecurePreferences.instance().getAccountUsername(XecurePreferences.instance().getDefaultAccountIndex()));
	...
	private boolean isUsernameCorrect(String username) {
		LinphoneProxyConfig lpc = XecureManager.getLc().createProxyConfig();
